                                            ...
                                            <div class="intro-content">
                                                <div class="section-title text-start  mt-70">
                                                    <div class="subtitle text-start" data-ani="slideindown"data-ani-delay="0.3s"> 
                                                        <img class="me-1"src="assets/images/shape/titleShape1_1.png" alt="icon">QUALITY & DESIGN EXCELLENCE 
                                                    </div>
                                                    <h1 class="text-start mt-15" data-ani="slideindown" data-ani-delay="0.5s">We Believe In The Quality And Design</h1>
                                                    <p class="desc" data-ani="slideinup" data-ani-delay="0.8s">With proven experience in the tile industry, we focus on delivering products that combine superior quality with modern design for long-lasting results.</p>
                                                </div>
                                    ...
                                    <div class="row gy-5 d-flex align-items-center">
                                        <div class="col-xl-6">
                                            <div class="intro-content">
                                                <div class="section-title text-start  mt-70">
                                                    <div class="subtitle text-start" data-ani="slideindown"data-ani-delay="0.3s"> 
                                                        <img class="me-1"src="assets/images/shape/titleShape1_1.png" alt="icon">OUR GROWING TILE COLLECTION 
                                                    </div>
                                                    <h1 class="text-start mt-15" data-ani="slideindown" data-ani-delay="0.5s">Expanding Our Tile Collections For You</h1>
                                                    <p class="desc" data-ani="slideinup" data-ani-delay="0.8s">We continuously develop and promote our own tile collections to reach more customers and meet evolving design and project demands.</p>
                                                </div>
                            ...
                            <div class="about-content">
                                <div class="section-title text-start  mt-70">
                                    <div class="subtitle text-start wow fadeInUp" data-wow-delay=".5s"> <img
                                            class="me-1" src="assets/images/shape/titleShape1_1.png" alt="icon"> TILE & SURFACE SPECIALISTS </div>
                                    <h2 class=" text-start mt-15 wow fadeInUp" data-wow-delay=".3s">Trusted Tile & Surface Solutions in Dubai</h2>
                                    <p class="desc wow fadeInUp" data-wow-delay=".7s">We are a reliable supplier of premium tiles, stone, and surface materials based in Al Qusais Industrial Area 3, Dubai. With years of industry experience, we serve residential, commercial, and project-based requirements across Dubai and the UAE, delivering quality products that combine durability, modern design, and consistent performance.</p>
                                </div>
                                ...
                                <div class="row gy-3 fancy-box-area">
                                    <div class="col-xl-6">
                                        <div class="fancy-box style1 wow fadeInUp" data-wow-delay=".3s">
                                            <div class="icon"><img src="assets/images/icon/aboutIcon1_1.svg" alt="icon">
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="fancy-box style1 wow fadeInUp" data-wow-delay=".5s">
                                            <div class="icon"><img src="assets/images/icon/aboutIcon1_2.svg" alt="icon">
                                            </div>
            ...
            <div class="row d-flex align-items-end  mb-50">
                <div class="col-xl-6">
                    <div class="section-title text-start">
                        <div class="subtitle text-start text-white wow fadeInUp" data-wow-delay=".5s"> <img class="me-1"
                                src="assets/images/shape/titleShape1_1.png" alt="icon"> QUALITY MATERIALS </div>
                        <h2 class="text-white text-start mt-15 wow fadeInUp" data-wow-delay=".3s">Trusted Tile Products for Every Project</h2>
                    </div>
                </div>
                            ...
                            <?php foreach ($products as $product): ?>
                                <div class="swiper-slide">
                                    <div class="service-card style1 img-custom-anim-left wow fadeInUp">
                                        ...
                                        <p><?= strlen($product['desc']) > 100 ? rtrim(substr($product['desc'], 0, 100)) . '...' : $product['desc']; ?>
                                        </p>
                                        <a href="<?= $product['slug']; ?>" class="theme-btn mt-3">
                                            <?= $product['cta']; ?> <i class="fal fa-arrow-right"></i>
                                        </a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
            ...
            <div class="container">
                <div class="section-title text-center mb-50 mxw-660 mx-auto">
                    <div class="subtitle text-center wow fadeInUp" data-wow-delay=".5s"> <img class="me-1"
                            src="assets/images/shape/titleShape1_1.png" alt="icon"> OUR EXPERTISE <img class="ms-1"
                    ...
                    <p class=" text-center mt-15 wow fadeInUp" data-wow-delay=".3s">We provide a complete range of tile, surface, and material solutions tailored to residential, commercial, and industrial project needs across Dubai and the UAE.</p>
                </div>
                                        ...
                                        <div class="content d-flex flex-column h-100">
                                            ...
                                            <ul class="checklist style1 mt-auto">
                                                <?php foreach ($offer['points'] as $point): ?>
                                                    <li><img src="assets/images/icon/check.svg" alt=""><?= $point; ?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <!-- <div class="swiper-slide">
                                <div class="offer-card style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div class="content">
                                        ...
                                        <h3>
                                            <a href="service-details.html">Modern Tiles</a>
                                        </h3>
                                        <p class="text">There are many flo variations of passages of atitl Lorem Ipsum
                                            available, but thedw,</p>
                                        <ul class="checklist style1">
                                            <li><i></i>More Expensive</li>
                                            <li><i></i>Elegant Vein Patterns</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="offer-card style1 img-custom-anim-right wow fadeInDown"
                                    data-wow-delay=".5s">
                                    <div class="bg"><img src="assets/images/offer/offerCardBg1_1.jpg" alt="bg"></div>
                                    <div class="content">
                                        <div class="icon">
                                        ...
                                        <a class="arrow-link" href="service-details.html">
                            ...
                            <div class="swiper-slide">
                                <div class="offer-card style1 img-custom-anim-top wow fadeInUp" data-wow-delay=".7s">
                                    ...
                                    <div class="content">
                                        ...
                                        <h3>
                                            <a href="service-details.html">Wood Floor Repair</a>
                                        </h3>
                                        <p class="text">There are many flo variations of passages of atitl Lorem Ipsum
                                            available, but thedw,</p>
                                        <ul class="checklist style1">
                            ...
                            <div class="swiper-slide">
                                <div class="offer-card style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div class="content">
                                        ...
                                        <h3>
                                            <a href="service-details.html">Floor Remove</a>
                                        </h3>
                                        <p class="text">There are many flo variations of passages of atitl Lorem Ipsum
                                            available, but thedw,</p>
                                        <ul class="checklist style1">
                        ...
                        <div class="col-xl-6">
                            <div class="wcu-content">
                                <div class="section-title text-start  mt-70">
                                    ...
                                    <p class="desc wow fadeInUp" data-wow-delay=".7s">Almaha is a trusted name in tile and surface solutions, delivering quality materials and reliable service for residential, commercial, and project-based requirements across Dubai and the UAE. Our approach is built on consistency, expertise, and long-term value.</p>
                                </div>
                                <div class="fancy-box style2 wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div class="fancy-item">
                                        ...
                                        <p>We supply carefully selected tiles and surface materials that meet industry standards for durability, performance, and modern design—ensuring long-lasting results for every project.</p>
                                    </div>
                                </div>
                                <div class="fancy-box style2 wow fadeInUp" data-wow-delay=".7s">
                                    ...
                                    <div class="fancy-item">
                                        ...
                                        <p>With strong knowledge of the UAE market and an efficient supply network, Almaha ensures timely material availability and dependable delivery across Dubai and the UAE.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="section-title mb-3">
                            <div class=" text-start subtitle wow fadeInDown" data-wow-delay=".3s"> <img class="me-1"
                                    src="assets/images/shape/titleShape1_1.png" alt="icon"> GET IN TOUCH <img class="ms-1"
                                    src="assets/images/shape/titleShape1_2.png" alt="icon"> </div>
                            <h2 class="text-start mt-15 wow fadeInDown" data-wow-delay=".5s">Let’s Discuss Your Project</h2>
                        </div>
                            ...
                            <form class="row" action="#">
                                ...
                                <div class="col-md-12">
                                    <select name="orderby" class="single-select" aria-label="Shop order">
                                        ...
                                        <option value="bathroom_tiles">Bathroom Tiles</option>
                                        <option value="kitchen_tiles">Kitchen Tiles</option>
                                        <option value="outdoor_tiles">Outdoor Tiles</option>
                                ...
                                <div class="col-12 col-md-6 form-group mb-0">
                                    <button type="submit" class="btn-wrapper theme-btn style3" style="max-width: 350px;">
                                        SUBMIT NOW
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="26" viewBox="0 0 41 26"
                                            fill="none">
                                            <rect width="1" height="26" fill="#2B1E16"></rect>
    ...
    <!-- <div class="skills-section fix">
        <div class="skills-container-wrapper style1">
            <div class="container">
                <div class="skills-wrapper style1 bg-theme2" data-bg-src="assets/images/bg/skillsBg1_1.jpg">
                    <div class="shape d-none d-xxl-block">
                        <img class="img-custom-anim-left wow fadeInLeft" data-wow-delay=".5s"
                            src="assets/images/shape/skillsShape1_1.png" alt="shape">
                    </div>
                    <div class="row gy-5 gy-md-0 gx-60">
                        <div class="col-xl-5">
                            <div class="skills-thumb img-custom-anim-left wow fadeInLeft" data-wow-delay=".5s">
                                <img src="assets/images/skills/skillsThumb1_1.jpg" alt="thumb">
                            </div>
                        </div>
                        <div class="col-xl-7">
                            <div class="skills-content section-padding  mxw-570">
                                <div class="section-title text-start mb-40">
                                    <div class="subtitle text-start wow fadeInUp" data-wow-delay=".5s"> <img
                                            class="me-1" src="assets/images/shape/titleShape1_1.png" alt="icon">
                                        EXPERTISE </div>
                                    <h2 class=" text-start mt-15 wow fadeInUp" data-wow-delay=".3s">Professionals to
                                        Install Flooring in Your Home</h2>
                                </div>
                                <p class="text">There are many variations of passages of Lorem Ipsum available, but the
                                    majority have suffered alteration in some form</p>
                                <div class="progress-wrap style1 wow fadeInUp" data-wow-delay=".2s">
                                    <div class="progress-meta">
                                        <div class="title">Hardwood Floor Repair</div>
                                ...
                                <div class="progress-wrap style1 wow fadeInUp" data-wow-delay=".5s">
                                    <div class="progress-meta">
                                        <div class="title">Custom Projects With Unique Designs</div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="blog-card-items style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="blog-content">
                                <h3><a href="blog-details.html">Best Flooring for Modern Modern kitchen</a></h3>
                                <ul>
                                    <li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="blog-card-items style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="blog-content">
                                <h3><a href="blog-details.html">How to Make Your House Look High Wood Flooring</a></h3>
                                <ul>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="blog-card-items style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="blog-content">
                                <h3><a href="blog-details.html">Why choose plank over other flooring types?</a></h3>
                                <ul>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="blog-card-items style1 img-custom-anim-left wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="blog-content">
                                <h3><a href="blog-details.html">Best Tiels for Modern Modern kitchen</a></h3>
                                <ul>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
