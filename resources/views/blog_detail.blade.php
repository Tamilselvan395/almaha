        ...
        <div class="container">
            <div class="blog-details-area">
                <div class="row g-5">
                    ...
                    <div class="col-12 {{ count($blogs) >= 1 ? 'col-lg-8' : 'col-lg-12' }}">
                        <div class="blog-post-details">
                            <div class="single-blog-post">
                                <div class="post-featured-thumb" style="height: auto; overflow: hidden; margin-bottom: 25px;">
                                    <img src="{{ Storage::url($blog->image) }}" alt="{{ $blog->title }}" style="width: 100%; height: auto; object-fit: contain; display: block;">
                                </div>
                                <div class="post-content">
                                    ...
                                    <h3 class="wow fadeInUp" data-wow-delay=".4s" style="margin-bottom: 20px;">{{ $blog->title }}</h3>
                                        ...
                                        @foreach ($blogs as $recent_blog)
                                            <div class="recent-items">
                                                <div class="recent-thumb">
                                                    <img src="{{ Storage::url($recent_blog->image) }}" alt="{{ $recent_blog->title }}" style="object-fit: cover; width: 80px; height: 80px;">
                                                </div>
                                                <div class="recent-content">
                                                    <ul>
                                                        <li>
                                                            <img src="{{ asset('assets/images/icon/calendarIcon.svg') }}" alt="icon">
                                                            {{ $recent_blog->created_at ? $recent_blog->created_at->format('d M, Y') : '18 Dec, 2024' }}
                                                        </li>
                                                    </ul>
                                                    <h6>
                                                        <a href="{{ route('blog.detail', $recent_blog->slug) }}">
                                                            {{ $recent_blog->title }}
                                                        </a>
                                                    </h6>
                                                </div>
