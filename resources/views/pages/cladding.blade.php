            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumb wow fadeInUp" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/cladding-tiles.jpg') }}" alt="Cladding Tiles Dubai" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="specs-thumb wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/solid-surface.jpg') }}" alt="Cladding Tile Specifications" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="outdoor-thumb wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/marbles-granite.jpg') }}" alt="Cladding Tile Fixing Services Dubai" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="why-choose-thumb wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/porcelain-tiles.jpg') }}" alt="Why Choose Al Maha Cladding Tiles Supplier" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
