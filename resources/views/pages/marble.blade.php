            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-thumb sticky-image wow fadeInUp" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/m-1.png') }}" alt="Marble and Granite Dubai" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-2">
                    <div class="specs-thumb sticky-image wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/m-2.png') }}" alt="Natural Stone Specifications" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="outdoor-thumb sticky-image wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/m-3.png') }}" alt="Luxury Marble and Granite Dubai" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-2">
                    <div class="why-choose-thumb sticky-image wow fadeInUp mb-4 mb-lg-0" data-wow-delay=".3s">
                        <img src="{{ asset('assets/images/products/m-4.png') }}" alt="Why Choose Al Maha Natural Stone Supplier" class="img-fluid rounded shadow w-100">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
